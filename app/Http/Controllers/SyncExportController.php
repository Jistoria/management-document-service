...
class SyncExportController extends Controller
{
    public function export()
    {
        ...
        $catalog = Subsystem::with([
            'processCategories.processesRoot.requiredDocuments',
            'processCategories.processesRoot.children.requiredDocuments' // Docs del subproceso
        ])->get();
        ...
        return [
            ...
            'catalog' => SubsystemResource::collection($catalog),
        ];
    }
}
